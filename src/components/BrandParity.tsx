...
export default function BrandParity() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold text-expedia-blue mb-1">Brand Parity Dashboard</h2>
        <p className="text-sm text-expedia-muted">Feature alignment across Expedia Group brands</p>
      </div>
