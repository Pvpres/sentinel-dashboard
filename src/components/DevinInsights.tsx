...
export default function DevinInsights() {
  return (
    <div>
      <PageHeader title="Devin Fleet Insights" subtitle="Organization-wide AI engineering agent metrics" />
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          <Card className="col-span-7 p-4">
            <h3 className="text-sm font-medium text-expedia-text mb-3">ROI Breakdown</h3>
          ...
          <Card className="col-span-5 p-4">
            <h3 className="text-sm font-medium text-expedia-text mb-3">Recent Activity</h3>
