...
export default function ServiceDetail({ serviceName }: ServiceDetailProps) {
  ...
  return (
    <div>
      <PageHeader title={detail.repoName} subtitle={detail.description}>
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md text-xs font-medium bg-white/10 text-white border border-white/20">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-5 space-y-4">
            <Card className="p-4">
              <h3 className="text-sm font-medium text-expedia-text mb-3">Service Health</h3>
            ...
            <Card className="p-4">
              <h3 className="text-sm font-medium text-expedia-text mb-3">Kubernetes Cluster</h3>
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
            ...
            <Card className="p-4">
              <h3 className="text-sm font-medium text-expedia-text mb-3">Dependencies</h3>
          ...
          <div className="col-span-7 space-y-4">
            <Card className="p-4">
              <h3 className="text-sm font-medium text-expedia-text mb-3">Brand Feature Usage</h3>
            ...
            <Card className="p-4">
              <h3 className="text-sm font-medium text-expedia-text mb-3">Devin Activity Feed</h3>
              <div className="space-y-2">
