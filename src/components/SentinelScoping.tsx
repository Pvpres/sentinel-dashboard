...
export default function SentinelScoping() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold text-expedia-blue mb-1">Sentinel Scoping</h2>
        <p className="text-sm text-expedia-muted">Configure Devin audit scope across the service fleet</p>
      </div>
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-medium text-expedia-blue">Service Selector</h3>
      ...
      <Card className="p-4">
        <h3 className="text-sm font-medium text-expedia-blue mb-3">Audit Queue Status</h3>
